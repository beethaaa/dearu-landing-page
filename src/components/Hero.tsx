...
const Hero = () => {
  ...
  return (
    <section id="our-story" ref={ref} className="relative w-full min-h-screen flex flex-col items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center text-center px-4 max-w-5xl mx-auto mt-10">
        ...
        >
          ...
          <p className="text-lg md:text-2xl text-pearl-pink/90 max-w-2xl mx-auto leading-loose tracking-wide font-inter font-light relative z-10 drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
            DearU is a social & dating app that helps you find special connections
            beyond the screen - right in the real world.
          </p>

          <a href="#" className="mt-16 relative group inline-flex justify-center items-center hover:scale-105 transition-transform duration-500">
            <div className="absolute inset-0 bg-magic-glow rounded-full blur-[40px] opacity-40 group-hover:opacity-80 transition-opacity duration-500"></div>
            <img src="/assets/DownloadButton.png" alt="Download App Now" className="relative z-10 h-32 md:h-48 w-auto object-contain drop-shadow-[0_0_20px_rgba(255,0,127,0.5)] group-hover:drop-shadow-[0_0_40px_rgba(255,0,127,1)] transition-all duration-500" />
          </a>
        </motion.div>
      </div>
    </section>
